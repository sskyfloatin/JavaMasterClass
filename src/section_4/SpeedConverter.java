...
public class SpeedConverter {
	...
	//https://www.udemy.com/java-the-complete-java-developer-course/learn/v4/t/lecture/13671990?start=0

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		//calling 1st method to return value and taking it to var to print that var
		long miles=toMilesPerHour(-2.0);
		System.out.println("Miles = "+miles);
		
		//calling 2nd method to print text
		printConversion(-2.0);
	}
	...
	public static void printConversion(double kilometersPerHour) {
		...
		if(kilometersPerHour < 0) {
			...
			long milesPerHour = toMilesPerHour(kilometersPerHour);	//здесь мы обращаемся к созданному методу kilometersPerHour 
			//чтобы избежать дупликации кода.Math.round(kilometersPerHour / 1.609)
