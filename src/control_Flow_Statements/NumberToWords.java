...
public class NumberToWords {
	...
	public static void numberToWords(int number) {
		int countInOriginalNumber = getDigitCount(number);
		System.out.println(countInOriginalNumber);
...
//		System.out.println("Reversed number is "+number);
		...
		int countInReversedNumber = reverse(number);
//		System.out.println("Count in Original Number " +countInOriginalNumber);
//		System.out.println("Count in reversed number " +countInReversedNumber);
		...
		while(number > 0) {
			...
			//block to deal with number starting with zero
			
			if(countInReversedNumber < countInOriginalNumber) {
				for(int i = 1;i < countInOriginalNumber;i++) {
...
//		}
		...
		while(number != 0) {
			reverseNumber*=10; //
			lastDigit = number%10;//estract last digit;
			
			number/=10;//discard last digit;
			reverseNumber = reverseNumber+lastDigit;//concatenate last digits
...
//		System.out.println(getDigitCount(124893));
